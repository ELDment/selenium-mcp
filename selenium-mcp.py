...
class SeleniumMCPApp:	
	...
	def _registerTools(self):
		"""注册所有MCP工具"""
		self._registerConnectionTools()
		self._registerNavigationTools()
		self._registerElementTools()
		self._registerReaderTools()
		self._registerUtilityTools()
	
	def _registerConnectionTools(self):
		"""注册连接和实例管理相关工具"""
		@self.mcp.tool()
	...
	def _registerNavigationTools(self):
		"""注册浏览器导航相关工具"""
		@self.mcp.tool()
	...
	def _registerElementTools(self):
		"""注册元素操作相关工具"""
		@self.mcp.tool()
	...
	def _registerUtilityTools(self):
		"""注册实用工具"""
		@self.mcp.tool()
